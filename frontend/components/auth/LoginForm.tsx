 ...
 * LoginForm Component
 *
 * User login form with email/password authentication and OAuth providers.
 * Uses Better Auth signIn.email and signIn.social for authentication.
 *
 * Features:
 ...
 * - Error display
 * - Support for callbackUrl redirect
 * - Redirect to /chat on success (or callbackUrl if provided)
 */
    ...
    await signIn.email(
      ...
      },
      {
        ...
        onError: (ctx) => {
          ...
          let errorMessage = ctx.error.message || "Login failed. Please try again.";
      ...
      <div className="bg-white dark:bg-gray-800 shadow-lg rounded-lg p-8">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 dark:text-gray-400 mt-2">
            Sign in to Physical AI & Humanoid Robotics
          </p>
        </div>
        ...
        <div className="space-y-3">
          ...
          >
            ...
            <span>{isOAuthLoading === "github" ? "Signing in..." : "Continue with GitHub"}</span>
          </button>
        </div>
